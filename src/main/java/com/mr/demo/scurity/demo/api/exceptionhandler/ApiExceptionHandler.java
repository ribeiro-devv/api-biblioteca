...
import com.mr.demo.scurity.demo.exception.EntidadeEmUsoException;
import com.mr.demo.scurity.demo.exception.EntidadeNaoEncontradaException;
import com.mr.demo.scurity.demo.exception.NegocioException;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleUncaught(Exception ex, WebRequest request) {
        ...
        String detail = Constates.MSG_ERRO_GENERICA_USUARIO_FINAL;
    ...
    protected ResponseEntity<Object> handleNoHandlerFoundException(NoHandlerFoundException ex,
        ...
        Problem problem = createProblemBuilder(status, problemType, detail)
                .userMessage(Constates.MSG_ERRO_NOT_FOUND)
                .build();
    ...
    private ResponseEntity<Object> handleMethodArgumentTypeMismatch(
        ...
        Problem problem = createProblemBuilder(status, problemType, detail)
                .userMessage(Constates.MSG_ERRO_GENERICA_USUARIO_FINAL)
                .build();
